...
; HG name: SaveArray_Party_Get
SaveData_GetParty equ 0x02074904
; HG name: Party_GetMonByIndex
Party_GetPokemonBySlotIndex equ 0x02074644
; HG name: GetMonData
Pokemon_GetValue equ 0x0206E540
; HG name: SetMonData
Pokemon_SetValue equ 0x0206EC40
; HG name: CalcMonExpToNextLevel
Pokemon_GetExpToNextLevel equ 0x0206FCA0
; HG name: CalcMonLevelAndStats
Pokemon_CalcLevelAndStats equ 0x0206E250
; HG name: Party_GetCount
Party_GetCurrentCount equ 0x02074640
...
.org 0x020fb094 ; Overwrite pointer in scrcmd (ScrCmd_229)
