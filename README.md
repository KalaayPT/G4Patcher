...
This program provides a GUI for selecting an unpacked ROM folder (such as one generated by [DSPRE](https://github.com/Mixone-FinallyHere/DS-Pokemon-Rom-Editor/tree/v1.13.1-beta)), then one of the included patches, then checks for:
...
1. Download the latest [release](https://github.com/KalaayPT/g4patcher/releases) to install
2. Run G4Patcher
